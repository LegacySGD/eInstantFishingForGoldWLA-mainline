...
public class FishingForGoldWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(FishingForGoldWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/FishingForGoldWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/FishingForGoldWLAIW/InitOutcome.xml").getDocumentElement();
